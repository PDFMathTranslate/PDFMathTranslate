"""Unicode character data tables for the bidirectional algorithm.

Generated from the Unicode Character Database (BidiBrackets.txt,
BidiMirroring.txt).  Regenerate with script/gen_bidi_tables.py when bumping
the supported Unicode version.
"""

# BidiBrackets.txt -- opening bracket -> its paired closing bracket.
OPENING_BRACKETS: dict[int, int] = {
...
# BidiBrackets.txt -- closing bracket -> its paired opening bracket.
CLOSING_BRACKETS: dict[int, int] = {
    0x0029: 0x0028, 0x005D: 0x005B, 0x007D: 0x007B, 0x0F3B: 0x0F3A, 0x0F3D: 0x0F3C, 0x169C: 0x169B,
    0x2046: 0x2045, 0x207E: 0x207D, 0x208E: 0x208D, 0x2309: 0x2308, 0x230B: 0x230A, 0x232A: 0x2329,
    ...
    0x298E: 0x298F, 0x2990: 0x298D, 0x2992: 0x2991, 0x2994: 0x2993, 0x2996: 0x2995, 0x2998: 0x2997,
...
# BidiMirroring.txt -- character -> its mirrored form (UAX #9 rule L4).
...
# Canonical equivalences that matter for bracket pairing (UAX #9 BD16 note).
CANONICAL_BRACKETS: dict[int, int] = {
    0x3008: 0x2329,
    0x3009: 0x232A,
}
